...
?> | <?php echo count_words ($text); ?> <?php  print ' | 围观：'; the_views(); print '次'; ?>
			</div>
		</div>
		<div class="clear"></div>
	</div>
...
<?php
	$scrollcount = get_option('swt_new_post');//获取后台设置的最新文章显示的数目
 ?>
<?php 
	$sticky = get_option('sticky_posts');
	$swt_catagelory = get_option('swt_new_exclude');
	$args=array(
	'caller_get_posts' => 6,
...
<div class="entry_box">
	...
	<div class="box_entry">
		<div class="box_entry_title">
			...
			<div class="info">
			  <span class="date"><?php the_time('Y年m月d日') ?></span> | <?php echo count_words ($text); ?> <?php  print ' | 围观：'; the_views(); print '次'; ?>
			</div>
		</div>
		<div class="clear"></div>
...
<?php if ($wp_query->current_post == 0) : ?>
	<?php if (get_option('swt_adh') == '关闭') {echo ''; } else { ?>
<div id="pd_h">
		<div id="pd_h_c"></div>
</div>

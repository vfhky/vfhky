...
<?php }} ?>
	...
	<div id="respond">
		...
		<p><strong>XHTML：</strong> 开放Tag最大权限：支持 <code> &lt;span style=""&gt;</code> 标签<br/><strong>快捷提交：</strong> Ctrl+Enter<br/><span style="color:#ccc;"><strong>留言须知：</strong> 1.使用Gravatar头像，才能发表评论；</span><br/><span style="color:#ccc;margin-left:63px;">2.插入图片最大支持520*200，等比缩放；</span><br/><a href="http://www.huangkeye.cn/siteverify" title="查看 黑名单" target="_blank"><span style="color:#FF4500;margin-left:63px;">3.已开启广告黑名单功能，发现即拉黑广告网站！&rArr;查看&lArr;</span></a></p>
		</p>

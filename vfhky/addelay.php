...
<?php  wp_reset_query(); if (is_single()){ ?>
	<span id="pd_r_2"><?php echo stripslashes(get_option('swt_ad_rc')); ?></span>
	<span id="pd_h_c_1"><?php echo stripslashes(get_option('swt_adtc')); ?></span>
	<span id="pd_h_c_2"><?php echo stripslashes(get_option('swt_ad_c')); ?></span>
	<script type="text/javascript">
...
<span id="ads_c_1"><?php echo stripslashes(get_option('swt_adsc')); ?></span>
	<script type="text/javascript">

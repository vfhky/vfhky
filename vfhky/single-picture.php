...
<div id="content">
		...
		<div class="entry_box_s">
			...
			<div class="img_info">
				...
				<ul class="comment"> <?php if(function_exists('the_views')) { echo '浏览次数：'; the_views();} ?>次</ul>
...
<div class="foot1">
	...
	<a href="<?php echo stripslashes(get_option('vfhky_link_s')); ?>" title="申请友链">友情链接</a></h2><?php } ?>
        <?php wp_reset_query();if ( !is_home()){ ?><h2 class="blogtitle">
...
<?php wp_reset_query();if ( is_home()){ ?>
	...
	?><li><a href="<?php echo stripslashes(get_option('vfhky_link_s')); ?>">更多...</a></li>
	<div class="clear"></div>
    </div>
<?php } ?>	
  ...
  -->
	...
	<span id="pd_h_c_2"><?php echo stripslashes(get_option('vfhky_adtc')); ?></span>

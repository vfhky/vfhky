...
class vfhky_QC_class{
	...
	public $appid = "100283136";//此处填写申请的appid
	public $appkey = "";//此处填写申请的appkey，这里就不演示了，你懂的
	public $callback = "huangkeye.cn/wp-content/themes/vfhky/wpwplogin.php";//这里填写你申请的回调地址
